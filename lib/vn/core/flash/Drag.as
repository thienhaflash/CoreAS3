package vn.core.flash
{
	...
	/**
	 * A better Mouse Drag/Drop behavior control compared with flash's build in startDrag / stopDrag
	 * 
	 ...
	 * 
	 * @todo
	 * 		Addding support for multiple Drag actions for the same target (with different key combination)
	 * 		Adding Dispatcher supported
	 * 
	 */ 
